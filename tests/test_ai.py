...
def _make_d():
    ...
    return dict(
        ...
        curr_M=205, curr_S=4.8e7,
        memG_curr=-0.014, shrG_curr=-0.04,
        eLoan=0.42, eRate=0.83, eOvd=0.035, R0=0.95, eProv=0.015,
        status="📊 一般狀態", reason_text="各指標平穩",
        M3=220, M2=215, M1=210, M0=208,
        S3=5.8e7, S2=5.5e7, S1=5.2e7, S0=5.0e7,
        R1=0.96,
        df_m=df_m, df_l=df_l,
    )
