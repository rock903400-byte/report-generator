...
from report_charts import (
    style_fig,
    to_html_div,
    chart_member_capital_trend,
    chart_loan_savings,
    chart_risk_trend,
    chart_ovd_full_history,
    chart_ovd_amount,
    chart_waterfall,
    chart_annual_trend,
    make_balance_sheet_html,
    chart_lending_rate,
    generate_all_charts,
)
...
def _build_d(with_csv=False):
    dates = pd.to_datetime(
        ["2026-04-01", "2025-12-01", "2025-06-01", "2024-12-01", "2024-06-01", "2023-12-01"]
    )
    df_m = pd.DataFrame(
        {
            "年月": dates,
